...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-grunt-angular-builder/node_modules/grunt-angular-builder/tasks/lib/types.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-grunt-angular-builder/node_modules/grunt-angular-builder/tasks/lib/types.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-grunt-angular-builder/node_modules/grunt-angular-builder/tasks/lib/</a> &#187; types.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function TaskOptions ()</span>
{}
&nbsp;
 ...
 * @interface
 */
<span class="fstat-no" title="function not covered" >function GruntFilesArrayExt ()</span>
{}
&nbsp;
 ...
 */
<span class="fstat-no" title="function not covered" >function MiddlewareInterface (context)</span>
{}
&nbsp;
MiddlewareInterface.prototype = {
   ...
   */
  analyze: <span class="fstat-no" title="function not covered" >function (filesArray) {</span>},
  /**
   ...
   */
  trace:   <span class="fstat-no" title="function not covered" >function (module) {</span>},
  /**
   ...
   */
  build:   <span class="fstat-no" title="function not covered" >function (targetScript) {</span>}
};
&nbsp;
//======================================================================================================================
&nbsp;
 ...
 * middleware options.
 */
<span class="fstat-no" title="function not covered" >function Context (grunt, task, defaultOptions)</span>
{
<span class="cstat-no" title="statement not covered" >  this.grunt = grunt;</span>
<span class="cstat-no" title="statement not covered" >  this.options = extend ({}, defaultOptions, task.options ());</span>
<span class="cstat-no" title="statement not covered" >  if (task.flags.debug !== undefined || grunt.option ('build') === 'debug') {</span>
<span class="cstat-no" title="statement not covered" >    this.options.debugBuild.enabled = true;</span>
<span class="cstat-no" title="statement not covered" >    this.options.releaseBuild.enabled = false;</span>
  }
<span class="cstat-no" title="statement not covered" >  this.verbose = grunt.option ('verbose');</span>
  // Clone the external modules and use it as a starting point.
<span class="cstat-no" title="statement not covered" >  this.modules = extend ({}, this._setupExternalModules ());</span>
  // Reset tracer.
...
<span class="cstat-no" title="statement not covered" >  this.standaloneScripts = (this.options.require || []).slice ();</span>
...
Context.prototype = {
   ...
   */
  listen:                <span class="fstat-no" title="function not covered" >function (eventName, handler)</span>
  {
<span class="cstat-no" title="statement not covered" >    if (!this._events[eventName])</span>
<span class="cstat-no" title="statement not covered" >      this._events[eventName] = [];</span>
<span class="cstat-no" title="statement not covered" >    this._events[eventName].push (handler);</span>
  },
  /**
   * Calls all registered event handlers for the specified event.
   * @param {ContextEvent} eventName
   */
  trigger:               <span class="fstat-no" title="function not covered" >function (eventName)</span>
  {
<span class="cstat-no" title="statement not covered" >    var e = this._events[eventName];</span>
<span class="cstat-no" title="statement not covered" >    if (e)</span>
<span class="cstat-no" title="statement not covered" >      e.forEach (<span class="fstat-no" title="function not covered" >function (handler)</span></span>
      {
<span class="cstat-no" title="statement not covered" >        handler ();</span>
   ...
   * @private
   */
  _setupExternalModules: <span class="fstat-no" title="function not covered" >function ()</span>
  {
    /** @type {Object.&lt;string, ModuleDef&gt;} */
<span class="cstat-no" title="statement not covered" >    var modules = {};</span>
<span class="cstat-no" title="statement not covered" >    ((typeof this.options.externalModules === 'string' ?</span>
      [this.options.externalModules] : this.options.externalModules
      ) || []).
      concat (this.options.builtinModules).
      forEach (<span class="fstat-no" title="function not covered" >function (moduleName)</span>
    {
      // Ignore redundant names.
<span class="cstat-no" title="statement not covered" >      if (!modules[moduleName]) {</span>
        /** @type {ModuleDef} */
<span class="cstat-no" title="statement not covered" >        var module = modules[moduleName] = new ModuleDef (moduleName);</span>
<span class="cstat-no" title="statement not covered" >        module.external = true;</span>
      }
    });
 ...
 * @param {string} name
 */
<span class="fstat-no" title="function not covered" >function ModuleDef (name)</span>
{
...
<span class="cstat-no" title="statement not covered" >  this.filePaths = [];</span>
}
&nbsp;
ModuleDef.prototype = {
  /**
